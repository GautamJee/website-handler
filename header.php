...
<html>
    <head>
        <title><?php echo stripslashes($pageDetails["page_title"]); ?>  <?php echo SITE_NAME; ?> - By GAUTAM</title>
                ...
                <div class="row">
                    <div class="12u">
                        <header id="header">
                            ...
                            <nav id="nav">
                                <a href="about.php" <?php echo ($currentPage == "About") ? ' class="current-page-item"' : '' ?> >About</a>
                                <a href="category.php" <?php echo ($currentPage == "Category") ? ' class="current-page-item"' : '' ?>>Category</a>
                                <a href="contact-me.php" <?php echo ($currentPage == "Contact-Me") ? ' class="current-page-item"' : '' ?>>Contact Me</a>
