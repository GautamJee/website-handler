...
if (isset($_POST["sbtn"])) {
	...
	if ($res) {
		simple_redirect("contact-me.php?msg=success");
	} else {
		simple_redirect("contact-me.php?msg=error");
	}
}
include("header.php");
?>
<img src="https://lh3.googleusercontent.com/-bkuBQREfYa8/AAAAAAAAAAI/AAAAAAAAB0Y/OawcVLvQOak/s60-p-no/photo.jpg" />
  ...
  <div class="8u">
    <section class="left-content">
     <h2><?php echo stripslashes($pageDetails["page_title"]); ?></h2>
      ...
      <div class="success">Thank you for contacting... My team will get back to you withinh 24 hours.</div>
      <?php } if ($_GET["msg"] == "error") {  ?>
      <div class="error">There was problem sending mail. please try again or try later.</div>
      <?php } ?>
      <form action="contact-me.php" method="post" name="f" onsubmit="return validateForm();">
        <div class="rows">
